...
--
-- Host: localhost
-- Generation Time: Apr 13, 2013 at 12:38 AM
...
CREATE TABLE IF NOT EXISTS `tb_vacina_fabricante` (
  ...
  PRIMARY KEY (`cod_vacina`,`cod_fabric`),
...
ALTER TABLE `tb_endereco`
  ADD CONSTRAINT `fk_tb_cidade_endereco` FOREIGN KEY (`cod_cid`) REFERENCES `tb_cidade` (`cod_cid`);
...
--
-- Constraints for table `tb_paciente_mensagem`
--
ALTER TABLE `tb_paciente_mensagem`
...
ALTER TABLE `tb_vacina_fabricante`
  ADD CONSTRAINT `fk_vacina_fabricante` FOREIGN KEY (`cod_fabric`) REFERENCES `tb_fabricante` (`cod_fabric`),
  ADD CONSTRAINT `fk_tb_cod_vacina` FOREIGN KEY (`cod_vacina`) REFERENCES `tb_vacina` (`cod_vac`);
