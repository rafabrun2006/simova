...
--
-- Host: localhost
-- Generation Time: Apr 09, 2013 at 01:56 AM
...
(57, 1, 1, 'Rua da pedra', 123456789, 'Pedregal', 9, '11'),
(58, 1, 1, 'Rua da pedra', 123456789, 'Pedregal', 9, '11'),
(60, 2, 1, 'Quadra 10', 11111111, 'Pedregal', 2, 'igreja evangelica');
...
(36, 1, 'rafabrun2009', '912ec803b2ce49e4a541068d495ab570'),
...
(1, 1, 1, 34, NULL, 57, 'Dino da Silva Sauro', '123456789', 'Rossete da Silva Sauro', 'Jonas da Silva Sauro', 'M', '123456789', '2013-04-11', '123456789', 'rafabrun2006@gmail.com', 1, 1, NULL, NULL),
(2, 1, 1, 37, NULL, 58, 'Dino da Silva Sauro', '123456789', 'Rossete da Silva Sauro', 'Jonas da Silva Sauro', 'M', '123456789', '2013-04-08', '123456789', 'rafabrun2006@gmail.com', 1, 1, NULL, NULL);
...
(1, 60, 'Postinho Paraisopolis', 104);
...
ALTER TABLE `tb_lote_vacina`
  ADD CONSTRAINT `tb_lote_vacina_ibfk_2` FOREIGN KEY (`cod_vacina`) REFERENCES `tb_vacina` (`cod_vac`),
  ADD CONSTRAINT `tb_lote_vacina_ibfk_1` FOREIGN KEY (`cod_lote`) REFERENCES `tb_lote` (`cod_lote`);
